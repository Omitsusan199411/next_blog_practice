		...
		<div className="container mx-auto mt-10">
			...
			<form action={formAction} className="space-y-4">
				<div>
					...
					<Input id="title" name="title" placeholder="タイトルを入力してください" className="mt-2"/>
					{state.errors.title && (
				...
				<div>
					...
					<Input type="file" id="topImage" name="topImage" accept="image/*" className="mt-2"/>
				...
				<Button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-md">登録する</Button>
			</form>
		</div>
	)
}
