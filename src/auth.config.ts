...
export const authConfig = {
	...
	callbacks: {
		authorized: async ({ auth, request: { nextUrl } }) => { // authorizedコールバックは、リクエストがNext.jsミドルウェアを含むページへのアクセスを許可されているかどうかを確認する。authにはユーザーのセッションが含まれる。requestにはユーザーからの受信リクエストを受け取る
